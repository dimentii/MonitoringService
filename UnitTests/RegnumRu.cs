...
{
    [TestClass]
    public class RegnumRu
    {
        private static List<FeedItem> _articles;

        private static readonly Worker Worker = new WebsiteWorkers.Workers.RegnumRu();

        private const String RssLink = "http://www.regnum.ru/rss/index.xml";
